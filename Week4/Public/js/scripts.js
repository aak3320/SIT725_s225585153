      ...
      <div class="col s12 m6 l4 center-align">
        <div class="card medium book-card">
          ...
          <div class="card-reveal">
            ...
            <p class="card-text"><strong>Author:</strong> ${item.author}</br> <strong>Genre:</strong> ${item.genre}</br></br> ${item.description}</p>
          </div>
        </div>
      </div>`;
...
//Use books details for cards from database instead of static array
const getBooks = () => {
